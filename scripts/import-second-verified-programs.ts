...
import { secondVerifiedPrograms } from "./data/second-verified-programs";
...
async function main() {
  ...
  const results = await importVerifiedProgramBatch(secondVerifiedPrograms, { databaseUrl, adminEmail, publish });
